...
GO_BUILD_TAGS=""
GOTEST_OPT?= -v -race -timeout 600s -parallel 4 -count=1 --tags=$(GO_BUILD_TAGS)
GOTEST_LONG_RUNNING_OPT?= -v -race -timeout 1800s -parallel 4 -count=1 -tags=long_running,$(GO_BUILD_TAGS)
